function [rhsrho, rhsrhou, rhsEner] = EulerQRHS1D(rho, rhou ,Ener)
...
rhoin    = 1.000;    rhouin   = 0.000;
q_tp_in  = 0.5*q_tp; q_tp_out = 0.5*q_tp;     
pin      = 1.000;    Enerin   = q_tp_in;
rhoout   = 0.125;    rhouout  = 0.000;
pout     = 0.100;    Enerout  =q_tp_out;

% Set fluxes at inflow/outflow
rhofin =rhouin; rhoufin=rhouin.^2./rhoin+pin; 
Enerfin=(0.5*rhouin^2/rhoin).*rhouin./rhoin + q_tp_in;
...
Enerfout=(0.5*rhouout^2/rhoout+pout).*rhouout./rhoout + q_tp_out;
